...
function ForgotPassword() {
    ...
    useEffect(() => {
        // The reset-password token cookie is now httpOnly (cannot be read by JS) for
        // security. We use a separate, non-sensitive sessionStorage flag purely to
        // restore the "enter OTP" UI step if the user reloads the page.
        const flag = sessionStorage.getItem('resetPasswordRequested');
        if (flag === '1') {
            setIsEmailSent(true);
        }
    }, []);
    ...
    const handleEmailSubmit = async (values) => {
        try {
            ...
            setIsEmailSent(true);
            sessionStorage.setItem('resetPasswordRequested', '1');
    ...
    const handleResetPassword = async (values) => {
        try {
            ...
            sessionStorage.removeItem('resetPasswordRequested');
